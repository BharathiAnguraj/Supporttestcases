...
Mobile.startApplication("storage:filename=IvyDMS_PNGIndia_1571_9917.apk", false)

if (Mobile.verifyElementExist(findTestObject('Mobile/Activation Key/Button Allow'), 5, FailureHandling.OPTIONAL)) {
    Mobile.tap(findTestObject('Mobile/Activation Key/Button Allow'), 0)
}

if (Mobile.verifyElementExist(findTestObject('Mobile/Activation Key/Button Allow'), 
...
if (Mobile.verifyElementExist(findTestObject('Object Repository/Mobile/Activation Key/Successfully activated'),30, FailureHandling.OPTIONAL)) {
    Mobile.tap(findTestObject('Object Repository/Mobile/Activation Key/Button - OK'), 0)
}


if (Mobile.verifyElementExist(findTestObject('Mobile/Login/Username'), 10, FailureHandling.OPTIONAL)) {
	...
	if (!(userName.equals(GlobalVariable.dseUser))) 
		{
			Mobile.startApplication("lt://APP1016033751686815019884418", true)
...
if (Mobile.verifyElementExist(findTestObject('Mobile/Activation Key/Button Allow'), 100, FailureHandling.OPTIONAL))
	...
	Mobile.waitForElementPresent(findTestObject('Object Repository/Mobile/Attendance/Header Attendance'), 50, FailureHandling.STOP_ON_FAILURE)
