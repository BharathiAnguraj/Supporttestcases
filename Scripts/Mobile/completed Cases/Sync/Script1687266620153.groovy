...
Mobile.verifyElementVisible(findTestObject('Mobile/Synchronization/title_Synchronization'), 0)
...
Mobile.verifyElementExist(findTestObject('Mobile/Synchronization/Popup/Data upload completed Successfully'), 0)
...
Mobile.tap(findTestObject('Mobile/Synchronization/Popup/Close Icon'), 0)
