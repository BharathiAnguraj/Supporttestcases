...
WebUI.scrollToElement(findTestObject('Web/Collection/Collection Details/Collection_Direct/Grid/row_checkbox'), 0)
...
refno = Long.toString(random.internalNextLong(1, 1000000000))
...
refno2 = Long.toString(random.internalNextLong(1, 10000000000))
